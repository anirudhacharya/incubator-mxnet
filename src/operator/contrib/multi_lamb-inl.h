...
std::tuple<at::Tensor, at::Tensor> multi_tensor_l2norm(
  int chunk_size,
  at::Tensor noop_flag,
  ...
  const float max_grad_norm)
{
  ...
  auto grad_norm_tuple = multi_tensor_l2norm(chunk_size, noop_flag, grad_list, false);

  // Compute per tensor param norm
  auto param_norm_tuple = multi_tensor_l2norm(chunk_size, noop_flag, param_list, true);
  ...
  auto update_norm_tuple = multi_tensor_l2norm(chunk_size, noop_flag, grad_list, true);
